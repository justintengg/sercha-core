...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/capability-preferences": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_domain.CapabilityPreferences"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Capability preferences",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_ports_driving.UpdateCapabilityPreferencesRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_sercha-oss_sercha-core_internal_core_domain.CapabilityPreferences": {
            "type": "object",
            "properties": {
                "bm25_search_enabled": {
                    "description": "Search preferences (can toggle down, but requires indexing to be enabled)",
                    "type": "boolean"
                },
                "embedding_indexing_enabled": {
                    "description": "Enable vector indexing",
                    "type": "boolean"
                },
                "team_id": {
                    "description": "TeamID is the team these preferences belong to",
                    "type": "string"
                },
                "text_indexing_enabled": {
                    "description": "Indexing preferences (explicitly controlled by user)",
                    "type": "boolean"
                },
                "updated_at": {
                    "description": "UpdatedAt tracks when preferences were last modified",
                    "type": "string"
                },
                "vector_search_enabled": {
                    "description": "Enable vector search (if embedding indexing enabled)",
                    "type": "boolean"
                }
            }
        },
        ...
        "github_com_sercha-oss_sercha-core_internal_core_domain.SearchResult": {
            ...
            "properties": {
                ...
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_domain.SearchResultItem"
                    }
                },
                "took": {
                    "type": "integer",
        ...
        "github_com_sercha-oss_sercha-core_internal_core_domain.SearchResultItem": {
            "type": "object",
            "properties": {
                "document_id": {
                    "type": "string"
        ...
        "github_com_sercha-oss_sercha-core_internal_core_ports_driving.CapabilityStatus": {
            "type": "object",
            "properties": {
                "active": {
                    "description": "Active indicates both available AND enabled",
                    "type": "boolean"
                },
                "available": {
                    "description": "Available indicates if the backend is configured and healthy",
                    "type": "boolean"
                },
                "enabled": {
                    "description": "Enabled indicates if the user has enabled this capability",
                    "type": "boolean"
                }
            }
        },
        ...
        "github_com_sercha-oss_sercha-core_internal_core_ports_driving.FeaturesCapability": {
            ...
            "properties": {
                "bm25_search": {
                    "description": "BM25Search indicates BM25 keyword search capability state (requires search engine)",
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_ports_driving.CapabilityStatus"
                        }
                    ]
                },
                "embedding_indexing": {
                    "description": "EmbeddingIndexing indicates embedding indexing capability state (requires embedding service + vector store)",
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_ports_driving.CapabilityStatus"
                        }
                ...
                "text_indexing": {
                    "description": "TextIndexing indicates BM25 text indexing capability state (requires search engine e.g. OpenSearch)",
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_ports_driving.CapabilityStatus"
                        }
                ...
                "vector_search": {
                    "description": "VectorSearch indicates vector similarity search capability state (requires embedding service + vector store)",
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_sercha-oss_sercha-core_internal_core_ports_driving.CapabilityStatus"
                        }
        ...
        "github_com_sercha-oss_sercha-core_internal_core_ports_driving.UpdateCapabilityPreferencesRequest": {
            "type": "object",
            "properties": {
                "bm25_search_enabled": {
                    "description": "BM25SearchEnabled controls BM25 search (requires text indexing)",
                    "type": "boolean"
                },
                "embedding_indexing_enabled": {
                    "description": "EmbeddingIndexingEnabled controls vector/embedding indexing",
                    "type": "boolean"
                },
                "text_indexing_enabled": {
                    "description": "TextIndexingEnabled controls BM25 text indexing",
                    "type": "boolean"
                },
                "vector_search_enabled": {
                    "description": "VectorSearchEnabled controls vector search (requires embedding indexing)",
                    "type": "boolean"
                }
            }
        },
