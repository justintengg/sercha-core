...
func TestGetCapabilities_NoProviders(t *testing.T) {
	...
	if caps.Features.TextIndexing.Available {
		t.Error("expected TextIndexing.Available to be false with no search engine")
	}
	if caps.Features.EmbeddingIndexing.Available {
		t.Error("expected EmbeddingIndexing.Available to be false with no embedding providers")
	}
	if caps.Features.BM25Search.Available {
		t.Error("expected BM25Search.Available to be false with no search engine")
	}
	if caps.Features.VectorSearch.Available {
		t.Error("expected VectorSearch.Available to be false with no embedding providers")
	}
}
...
func TestGetCapabilities_WithEmbeddingProviders(t *testing.T) {
	...
	if !caps.Features.TextIndexing.Available {
		t.Error("expected TextIndexing.Available to be true with search engine")
	}
	if !caps.Features.EmbeddingIndexing.Available {
		t.Error("expected EmbeddingIndexing.Available to be true with embedding providers + vector store")
	}
	if !caps.Features.BM25Search.Available {
		t.Error("expected BM25Search.Available to be true with search engine")
	}
	if !caps.Features.VectorSearch.Available {
		t.Error("expected VectorSearch.Available to be true with embedding providers + vector store")
	}
}
